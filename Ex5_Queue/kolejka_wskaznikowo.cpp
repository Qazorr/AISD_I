#include "kolejka_wskaznikowo.hpp"
#include <limits>
...
int menu()
{
    ...
    std::cout << "5. Wypisz wartosc elementu z tyłu kolejki" << std::endl;
    std::cout << "6. Wyczysc kolejke" << std::endl;
    ...
    while(run)
    {
        try {
            switch(menu())
            {
                ...
                case 4:
                    element = queue.front();
                    std::cout << "\n\033[32mElement z przodu kolejki ma wartosc\033[0m \033[1;5;31m" << element << "\033[0m\n";
                    break;

                case 5:
                    element = queue.back();
                    std::cout << "\n\033[32mElement z tylu kolejki ma wartosc\033[0m \033[1;5;31m" << element << "\033[0m\n";
                    break;
